        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8 relative z-10">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-500 mt-3 font-medium text-sm leading-relaxed max-w-xs mx-auto">
                Pour contacter votre medecin, ajoutez un enfant avec le <strong className="text-orange-600">code famille</strong> fourni par le cabinet.
              </p>
            </div>
              ...
              <div className="space-y-3">
                  ...
                  >
                    {editingChild === child.tokenId ? (
                      <div className="flex items-center gap-3">
                        ...
                        <button onClick={() => setEditingChild(null)} className="w-12 h-12 bg-gray-100 text-gray-500 rounded-xl flex items-center justify-center"><X size={20}/></button>
                      </div>
                    ) : (
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Ajoute le {child.addedAt.toLocaleDateString()}</p>
                        </div>
                        <div className="flex gap-1.5">
                          <button onClick={() => { setEditingChild(child.tokenId); setEditNickname(child.nickname); }} className="p-2.5 bg-gray-50 text-gray-500 hover:text-orange-500 rounded-xl transition-colors"><Pencil size={18}/></button>
                          <button onClick={() => setShowDeleteConfirm(child.tokenId)} className="p-2.5 bg-gray-50 text-gray-500 hover:text-red-500 rounded-xl transition-colors"><Trash2 size={18}/></button>
                        </div>
                      </div>
                    )}
                    ...
                    <AnimatePresence>
                      {showDeleteConfirm === child.tokenId && (
                        <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="pt-4 mt-4 border-t border-black/5 space-y-3">
                          ...
                          <p className="text-xs text-gray-500">Cette action est reversible en saisissant a nouveau le code famille.</p>
                          <div className="flex gap-2 pt-1">
                            ...
                            <button onClick={() => setShowDeleteConfirm(null)} className="flex-1 h-10 bg-gray-100 text-gray-500 rounded-xl font-bold text-xs">Annuler</button>
                          </div>
                        </motion.div>
                      )}
                    </AnimatePresence>
                ...
                >
                  ...
                  <div className="text-left">
                    <p className="font-bold text-gray-500 group-hover:text-orange-600 transition-colors">Ajouter un enfant</p>
          ...
          >
            ...
            >
              <div className="flex items-center justify-between mb-8">
                ...
                <button onClick={() => setShowAddChild(false)} className="p-2 bg-gray-100 rounded-xl text-gray-500"><X size={20}/></button>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-gray-500 text-xs">Utilisez la camera</p>
                    </div>
                  </button>
                </div>
              ) : (
                <div className="space-y-6">
                  <div className="space-y-4">
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest ml-1">Code Famille</label>
                      <input
                        value={newToken}
                    ...
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest ml-1">Surnom de l'enfant</label>
                      <input
                        value={newNickname}
